...
export const SubscriptionsPage = () => <ProtectedContractPage title="Subscriptions" description="Subscription state is server-owned. The frontend service boundary exists, but the final response contract is not yet approved, so no fixture subscriptions are rendered." endpoint="GET /api/subscriptions" />;
